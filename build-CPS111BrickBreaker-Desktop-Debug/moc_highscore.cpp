...
#include "../CPS111BrickBreaker/highscore.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HighScore_t, stringdata) + ofs \
...
const QMetaObject HighScore::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HighScore.data,
      qt_meta_data_HighScore,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HighScore.stringdata))
