...
public:
    ...
    void setupUi(QWidget *GameWindow)
    {
        ...
        lblCurrentHighScore->setGeometry(QRect(440, 30, 61, 21));
        ...
        lblCHS->setGeometry(QRect(500, 30, 66, 20));
        ...
        lblLevel_2->setGeometry(QRect(450, 70, 61, 16));
        lblLevel = new QLabel(GameWindow);
        lblLevel->setObjectName(QStringLiteral("lblLevel"));
        lblLevel->setGeometry(QRect(500, 70, 66, 17));
