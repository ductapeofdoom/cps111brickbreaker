...
#include "../CPS111BrickBreaker/gameworld.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GameWorld_t, stringdata) + ofs \
...
const QMetaObject GameWorld::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameWorld.data,
      qt_meta_data_GameWorld,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameWorld.stringdata))
